...
mysql_select_db($db_operators, $db_con);
...
function view($field)
{
	...
	for ( $i = 0; $i < count($column_names); $i++ )
	{
		...
		echo "<td><input class='rounded-textbox-search' size =\"20\" type='text' name='$column_names[$i]' value='$row_view[$i]' /></td></tr>";
	}
	echo "</tbody></table>";
...
function blank()
{
	...
	for ( $i = 0; $i < count($column_names); $i++ )
	{
		echo "$column_names[$i]:<input class='rounded-textbox-search' type='text' name='$column_names[$i]' /><br>";
	}
