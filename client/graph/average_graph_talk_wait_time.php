<?/// average_graph_talk_wait_time.php

function average_graph_talk_wait_time($_day,$_month, $_year, $_queue)
{
global $text_graphics_average_graph_talk_wait_time;
...
$strParam="rotateNames=1;yaxisname=$text_graphics_Seconds;numdivlines=9;divLineColor=CCCCCC;divLineAlpha=80;decimalPrecision=0;showAlternateHGridColor=1;AlternateHGridAlpha=30;AlternateHGridColor=CCCCCC;caption=$text_graphics_average_graph_talk_wait_time $text_graphics_Hours;animation=0";
				break;
			case '31': //Month
...
$strParam="rotateNames=1;yaxisname=$text_graphics_Seconds;numdivlines=9;divLineColor=CCCCCC;divLineAlpha=80;decimalPrecision=0;showAlternateHGridColor=1;AlternateHGridAlpha=30;AlternateHGridColor=CCCCCC;caption=$text_graphics_average_graph_talk_wait_time $text_graphics_Days;animation=0";
				break;
			case '12': //Year
				...
				$FC->addCategory($from_time_graph);$strParam="rotateNames=1;yaxisname=$text_graphics_Seconds;numdivlines=9;divLineColor=CCCCCC;divLineAlpha=80;decimalPrecision=0;showAlternateHGridColor=1;AlternateHGridAlpha=30;AlternateHGridColor=CCCCCC;caption=$text_graphics_average_graph_talk_wait_time $text_graphics_Months;animation=0";
				break;
		}
		...
		$talk_duration_day=round(($talk_duration_day/$complete),2);
		$overall_duration_day=round(($overall_duration_day/$complete),2);
