<?/// average_pie_talk_wait_time_per_day.php

function average_pie_talk_wait_time_per_day($_day, $_month, $_year, $_queue)
{
global $text_graphics_average_pie_talk_wait_time_per_day;
...
for($date=1;$date<=1;$date++)
{
	switch ($count)
	{
		case '24': // Day
			...
			$days=24;
			$strParam="caption=$text_graphics_average_pie_talk_wait_time_per_day $text_graphics_Hour;decimalPrecision=0;formatNumberScale=1;showNames=1;animation=0";
			break;
		case '31': //Month
			...
			$strParam="caption=$text_graphics_average_pie_talk_wait_time_per_day $text_graphics_Day;decimalPrecision=0;formatNumberScale=1;showNames=1;animation=0";
			break;
		case '12': //Year
			...
			$to_time='23:59:59';
			$days=12;
			$strParam="caption=$text_graphics_average_pie_talk_wait_time_per_day $text_graphics_Month;decimalPrecision=0;formatNumberScale=1;showNames=1;animation=0";
			break;
	}
