...
function sum_pie_complete_abandon($_day,$_month, $_year, $_queue)
{
global $text_graphics_sum_pie_complete_abandon;
...
for($date=1;$date<=1;$date++)
{
	switch ($count)
	{
		case '24': // Day
			...
			$strParam="caption=$text_graphics_sum_pie_complete_abandon $text_graphics_Day;decimalPrecision=0;formatNumberScale=1;showNames=1;animation=0";
			break;
		case '31': //Month
			...
			$from_time='00:00:00';
			$to_time='23:59:59';
			$strParam="caption=$text_graphics_sum_pie_complete_abandon $text_graphics_Month;decimalPrecision=0;formatNumberScale=1;showNames=1;animation=0";
			break;
		case '12': //Year
			...
			$from_time='00:00:00';
			$to_time='23:59:59';
			$strParam="caption=$text_graphics_sum_pie_complete_abandon $text_graphics_Year;decimalPrecision=0;formatNumberScale=1;showNames=1;animation=0";
			break;
	}	
...
$FC->addChartData($abandon,"name=$text_graphics_abandon,<br> ($text_graphics_calls);color=ea7697");
$FC->addChartData($complete,"name=$text_graphics_complete,<br> ($text_graphics_calls);color=73b27c");
